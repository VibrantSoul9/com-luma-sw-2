...
import org.openqa.selenium.By;
    ...
    public class LoginTest extends BaseTest {
        ...
        public void userShouldLoginSuccessfullyWithValidCredentials() throws InterruptedException {
            ...
            //Enter valid Email
            driver.findElement(By.id("email")).sendKeys("Yogmaya@gmail.com");
            Thread.sleep(3000);

            // Enter valid password
            driver.findElement(By.id("pass")).sendKeys("Yogmaya@108");
            Thread.sleep(3000);
            ...
            //verify the Text
            String expectedText = "Welcome, Yogmaya!";
        ...
        public void userShouldLogOutSuccessfully() throws InterruptedException {
            ...
            //Enter valid Email
            driver.findElement(By.id("email")).sendKeys("Yogmaya1@gmail.com");
            Thread.sleep(3000);

            // Enter valid password
            driver.findElement(By.id("pass")).sendKeys("Yogmaya@101");
            Thread.sleep(3000);
            ...
            //verify the Text
            String expectedText = "Welcome, Yogmaya1";
            String actualText = driver.findElement(By.xpath("(//span[@class='logged-in'])[1]")).getText();
            Assert.assertEquals(expectedText, actualText);
